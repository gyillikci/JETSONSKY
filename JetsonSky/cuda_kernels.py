############################################################################################################
#                                                                                                          #
#                                         JetsonSky CUDA Kernels                                           #
#                                                                                                          #
#                      Custom CUDA kernels for GPU-accelerated image processing                            #
#                                                                                                          #
...
"""
This module contains all custom CUDA kernels used in JetsonSky for GPU-accelerated
image processing operations. These kernels are implemented using CuPy's RawKernel
interface for maximum performance.

Kernels included:
- FNR (Frame Noise Reduction) kernels for mono and color images
- HDR computation kernels
- Binning kernels
- RGB alignment kernels
- Debayering kernels
- Dead pixel removal kernels
- Contrast and saturation adjustment kernels
- Denoising kernels (NLM2, KNN)
- And many more...
"""
